export const reducer = (prevState, action) => {
    switch (action.type) {
        ...
        case "CHANGE_PASSWORD_SUCCESS":
            return { ...prevState, isLoading: false, isChanged: true, messageChange: action.messageChange }
        case "UPDATE_USER_PROFILE_SUCCESS":
            return { ...prevState, isLoading: false, messageUpdate: action.messageUpdate }
        case "GET_USER_INFORMAION_FAIL":
            return { ...prevState, isLoading: true }
        case "CHANGE_PASSWORD_FAIL":
            return { ...prevState, isLoading: true, isChanged: false, messageChange: action.messageChange }
